...
If GridDB is configured for immediate consistency, the partition’s owner handles all client read and write requests and propagates updates to the backup nodes. If configured for eventual consistency, the replicas may respond to read requests.
