...
- **ACID auf Containerlevel**: Das Transaktionskonzept in GridDB richtet sich nach dem *ACID*-Prinzip auf dem Container-Level. ACID ist ein Akronym und steht für *Atomicity* (engl. für: Atomarität), *Consistency* (engl. für: Konsistenz), *Isolation* und *Durability* (engl. für: Dauerhaftigkeit). [Aki, „GridDB complies with ACID“]
- **IoT-optimiert**: GridDB wurde mit seiner Architektur speziell für IoT-Szenarien entwickelt und optimiert. [What is GridDB]
...
[?] Aki, „GridDB complies with ACID“, Fixstars, 11. Juli 2017, 2017. [Online]. Verfügbar unter: https://griddb.net/en/blog/griddb-complies-acid/. Zugriff am: 3. Januar 2022.
