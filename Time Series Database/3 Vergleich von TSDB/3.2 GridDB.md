...
GridDB kann für verschiedene Anwendungsbereiche eingesetzt werden. Generell eignen sie sich für den Einsatz in Verbindung mit cyber-physischen Systemen (engl.: cyber-physical system, kurz: *CPS*) und mit Monitoring-Systemen. Einige Beispiele werden im Folgenden aufgelistet und kurz erläutert.

- **Factory IoT**: Globale Produktionsumgebungen mit *Industrie-4.0*-Konzepten und damit einhergehenden Innovationen erfordern höhere Produktivität und Qualität. Ganze Wertschöpfungsketten müssen optimiert werden. Um diesen Innovationen gerecht zu werden, bietet GridDB hier IoT-basierte Produktionslösungen als IKT-Lösungen (kurz für: Informations- und Kommunikationstechnik) an. 
- 
- Toshiba offers the manufacturing IoT solutions "Meister Series" as ICT solutions to support this innovation.
- Automative Industry
- Energy
- BEMS
- Smart Community
