...
- **ACID auf Containerlevel**: Transaktionen in GridDB richten sich nach dem *ACID*-Prinzip auf dem Container-Level. ACID ist ein Akronym und steht für *Atomicity* (engl. für: Atomarität), *Consistency* (engl. für: Konsistenz), *Isolation* und *Durability* (engl. für: Dauerhaftigkeit). [Aki, „GridDB complies with ACID“]
